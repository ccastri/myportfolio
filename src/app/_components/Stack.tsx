...
<div className="absolute  group-hover:w-48  top-44 sm:top-24 sm:hidden h-2 ml-32 opacity-10 group-hover:opacity-100 w-0 mt-6  transition-all duration-500 group-hover:ease-in-out  bg-green-500 -z-20" />
