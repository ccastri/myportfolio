...
const Stack = () => {
  return (
    <main className="h-screen flex relative text-[#fafafa] bg-black flex-col items-center text-center justify-center w-screen border-2  ">
        ...
        <div className='group opacity-10 z-50 w-full h-full flex justify-between py-12  flex-col sm:px-8 hover:opacity-100'>
<>
        <h2 className='text-[#fafafa] text-2xl h-2 z-50'>Ongoing project:</h2>
      ...
      <div className='group sm:flex grid grid-cols-3 opacity-20 bottom-0 items-center gap-4 mx-auto text-center justify-center hover:opacity-70 z-20 py-4   w-full sm:justify-between bg-[#fafafa] border-2 rounded-md sm:p-8  '>
         ...
         <Image className="mx-auto text-center hover:scale-105 transition-all duration-200 hover:ease-in-out transform z-50" src="/opengl-logo.svg" alt="Slicer Logo" width={90} height={90}/>
      ...
      <span className='px-6 z-50 text-[#fafafa]'>Stack: <br/> Unity3D engine, 3D Slicer and Python to build a bridge for them both. <br/> 
