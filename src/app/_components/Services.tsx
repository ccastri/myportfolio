...
<div className='flex flex-col w-full space-y-6  '>
      ...
      <div className='bg-[#fafafa] blur-sm hover:blur-0 hover:text-[#fafafa] md:w-6/12 py-6 space-y-4 flex flex-col mx-auto rounded-xl sm:w-8/12 w-auto hover:bg-green-600 transition-all hover:ease-in-out duration-200 transform hover:scale-105 cursor-pointer'>
